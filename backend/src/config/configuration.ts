export default () => ({
  ...
  ICD_PREDICTOR_POLL_INTERVAL: parseInt(process.env.ICD_PREDICTOR_POLL_INTERVAL, 10) || 10000,
  ICD_PREDICTOR_POLL_TIMEOUT: parseInt(process.env.ICD_PREDICTOR_POLL_TIMEOUT, 10) || 600000,
