...
export const STANDARD_FIELD_MAP: Array<{
  ...
  { key: 'drgValue', draftKey: 'drgValues', label: 'DRG Value', placement: 'Chart Info', isArray: true },
  { key: 'procedureCode', draftKey: 'procedureCode', label: 'Procedure code', placement: 'Chart Info' },
  { key: 'pcsCodes', draftKey: 'pcsCodes', label: 'PCS codes', placement: 'Chart Info', isArray: true },
