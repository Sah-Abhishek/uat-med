...
export const updateSpecialitiesGeneral = (dto: SpecialitiesGeneralDto) =>
...
export interface FeedbackCategoryGroup {
  area:
    ...
    | 'POA Indicator'
    | 'Drug Value';
  categories: Array<{ id?: number; name: string; types: Array<{ id?: number; name: string }> }>;
}

export const getFeedbackCategories = (scope: { clientId?: number; locationId?: number } = {}) =>
  get<{ groups: FeedbackCategoryGroup[] }>(
    '/configurations/specialities/feedback-categories',
    scope,
  );

export const updateFeedbackCategories = (groups: FeedbackCategoryGroup[]) =>
  put<{ groups: FeedbackCategoryGroup[] }>(
    '/configurations/specialities/feedback-categories',
    { groups },
  );
...
export const updateAuditingConfig = (dto: AuditingConfig) =>
...
export const updateCodingConfig = (dto: CodingConfig) =>
...
export const getChartFieldsConfig = (scope: {
  ...
  locationId?: number;
  primarySpecialityId?: number;
}) => get<ChartFieldsConfig>('/configurations/specialities/chart-fields', scope);

export const updateChartFieldsConfig = (
  dto: ChartFieldsConfig & { clientId?: number; locationId?: number; primarySpecialityId?: number },
